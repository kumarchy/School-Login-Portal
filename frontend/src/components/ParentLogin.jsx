...
import styles from "./ParentSignin.module.css";
...
const ParentLogin = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      let response = await fetch("https://school-login-portal-backened-0zbt.onrender.com/parent_login", {
        method: "POST",
          ...
          <div className={styles.signup_page}>
            ...
            <div className={styles.signup_img}>
              <img
                ...
                src="https://img.freepik.com/premium-vector/real-life-family-moments-vector-illustration-concepts_1253202-51653.jpg?w=740"
                alt=""
              />
            </div>
            <p className={styles.acc_text}>
              Don't have an Account? <br />
              <Link to="/parent_register">Sign Up</Link>
            </p>
          </div>
        </div>
      </div>
